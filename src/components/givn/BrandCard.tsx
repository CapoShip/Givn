...
export function BrandCard({ brand, onClick }: BrandCardProps) {
  ...
  return (
    <div
      ...
      style={{
        // ✅ force le rendu texte plus net sous Chrome quand ça bouge en 3D
    ...
    >
      <div
        ...
        style={{
          // ✅ TILT 3D CONSERVÉ
          // ✅ SCALE SUPPRIMÉ (source #1 du flou)
          // ✅ angles un peu réduits (source #2 du flou)
          transform: isHovering
            ? `rotateX(${(mousePos.y - 100) / 14}deg) rotateY(${(mousePos.x - 100) / -14}deg)`
            : "rotateX(0deg) rotateY(0deg)",
          willChange: "transform",
        }}
      >
        {/* ✅ Glow radial SANS blur (le blur déclenche du compositing floutant) */}
        <div
        ...
        <div
          ...
          "
          style={{
            // ✅ aide Chrome à stabiliser le layer texte
            willChange: "transform",
        ...
        >
          ...
          <div className="mb-auto space-y-1.5 preserve-3d translate-z-30">
            ...
            <p
              className="text-[9px] font-bold uppercase tracking-widest text-zinc-600"
